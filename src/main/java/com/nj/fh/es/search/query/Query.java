package com.nj.fh.es.search.query;
...
/**
 * ES的一些查询，该类中的查询方法来源于TransportClient中的QueryBuilders类
 * @author 赵元路 18358572500 2019/9/12 8:49
 * @version 1.0
 */
public final class Query {
     ...
     * @param text The query text (to be analyzed). 查询的文本（将会被处理）
     */
     ...
     * term查询
     *
     * @param name  The name of the field 字段名
     * @param value The value of the term 词条
     */
